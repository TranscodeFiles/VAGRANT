...
chmod 600 /root/.ssh/*
sudo ssh-keyscan gitlab.aymericdaurelle.ovh > /root/.ssh/known_hosts
...
git clone -b basic-api-service git@gitlab.aymericdaurelle.ovh:transcodesupinfo/core-api.git /docker/core-api
